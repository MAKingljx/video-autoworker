...
describe('current video-command plugin installer', () => {
  it('owns the only supported 0.5.8 or 0.5.9 to 0.5.10 release path', async () => {
    ...
    expect(script).toContain('SUPPORTED_PREVIOUS_VERSIONS=("0.5.8" "0.5.9")')
    expect(script).toContain('is_supported_previous_version "$installed_version"')
    expect(script).toContain('CURRENT_VERSION="0.5.10"')
