...
function report(overrides = {}) {
  return {
    plugin: { id: 'aiworker-video-command', status: 'loaded', version: '0.5.6' },
...
describe('runtime inspection validator', () => {
  ...
  it.each([
    ['wrong id', report({ plugin: { id: 'other', status: 'loaded', version: '0.5.6' } })],
    ['not loaded', report({ plugin: { id: 'aiworker-video-command', status: 'disabled', version: '0.5.6' } })],
