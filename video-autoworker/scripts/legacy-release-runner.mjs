...
import { assertCleanGitSource } from './lib/git-source-layout.mjs'
import {
...
export async function main(argv = process.argv.slice(2)) {
  ...
  try { assertCleanGitSource(repository, plan.sourceCommit) } catch {
    fail('canonical repository is not the exact clean source')
  }
