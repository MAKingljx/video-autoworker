...
const gitSourceLayoutPath = resolve(process.cwd(), 'scripts/lib/git-source-layout.mjs')
const gitSourceLayoutShellPath = resolve(process.cwd(), 'scripts/lib/git-source-layout.sh')
...
function createLauncherFixture(): LauncherFixture {
  ...
  copyFileSync(
    gitSourceLayoutPath,
    join(projectRoot, 'scripts', 'lib', 'git-source-layout.mjs'),
  )
  copyFileSync(
    gitSourceLayoutShellPath,
    join(projectRoot, 'scripts', 'lib', 'git-source-layout.sh'),
  )
  copyFileSync(
