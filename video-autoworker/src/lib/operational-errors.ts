...
export const SAFE_OPERATION_ERROR_SUMMARIES = {
  ...
  DEPLOYMENT_LOCK_UNAVAILABLE: '无法安全取得共享发布锁',
  DEPLOYMENT_LOCK_RELEASE_FAILED: '共享发布锁释放失败',
  DIRECTOR_WORK_RESOLUTION_FAILED: '导演脑作品解析暂不可用',
  ...
  MATERIALS_GRAPH_FAILED: '无法读取素材关系图谱',
