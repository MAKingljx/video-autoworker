...
import { WorkspaceProjectsPanel } from '@/components/panels/workspace-projects-panel'
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (panelFromUrl === 'sessions' || panelFromUrl === 'chat') {
      router.replace('/profiles')
    }
  }, [panelFromUrl, normalizedPanel, router, setActiveTab])
  ...
  useEffect(() => {
    ...
    fetch('/api/auth/me')
      .then(async (res) => {
        ...
        if (res.status === 401 && !isLocalDesktopPanel) {
