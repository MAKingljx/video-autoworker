...
const endpoints: Endpoint[] = [
  ...
  { path: '/api/sessions/continue', methods: ['POST'], description: 'Continue an OpenClaw or local Qwen session with a prompt', tag: 'Sessions', auth: 'operator' },
  { path: '/api/sessions/transcript', methods: ['GET'], description: 'Read OpenClaw or local Qwen session transcript snippets', tag: 'Sessions', auth: 'viewer' },
