...
const navGroups: NavGroup[] = [
  {
    id: 'core',
    items: [
      { id: 'overview', label: '概览', icon: <OverviewIcon />, priority: true },
      { id: 'agents', label: '智能体', icon: <AgentsIcon />, priority: true },
      { id: 'tasks', label: '任务', icon: <TasksIcon />, priority: true },
    ],
  },
  {
    id: 'observe',
    label: '监控',
    items: [
      { id: 'activity', label: '活动', icon: <ActivityIcon />, priority: true },
      { id: 'logs', label: '日志', icon: <LogsIcon />, priority: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'spawn', label: '创建', icon: <SpawnIcon />, priority: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'history', label: '历史', icon: <HistoryIcon />, priority: false },
      { id: 'gateways', label: '网关', icon: <GatewaysIcon />, priority: false },
      { id: 'profiles', label: 'OpenClaw 配置', icon: <ProfilesIcon />, priority: false },
      { id: 'gateway-config', label: '配置', icon: <GatewayConfigIcon />, priority: false },
      { id: 'settings', label: '设置', icon: <SettingsIcon />, priority: false },
    ],
  },
]
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-2xs font-medium">更多</span>
      </Button>
