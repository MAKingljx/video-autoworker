  ...
  return (
    <div className="bg-card rounded-lg border border-border">
      <div className="p-4 border-b border-border">
        <h3 className="font-semibold text-foreground">活跃会话</h3>
        <p className="text-sm text-muted-foreground">
          共 {sessions.length} 个 • {activeSessions.length} 个活跃
        </p>
      </div>
      ...
      <div className="p-4">
        {sessions.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>暂无活跃会话</p>
            <p className="text-xs">智能体启动后，会话会显示在这里</p>
          </div>
        ) : (
