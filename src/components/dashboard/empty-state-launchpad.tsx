  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6">
      <div className="text-center mb-6">
        <h2 className="text-lg font-semibold text-foreground mb-1">启动流程</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StepCard
          ...
          doneContent={
            <div className="space-y-1">
              ...
              <p className="text-2xs text-muted-foreground/50 mt-1">已安装并就绪</p>
            </div>
          }
          pendingContent={
            <>
              <p className="text-xs text-muted-foreground mb-3">
                安装或连接 OpenClaw，用于管理本地千问和远端配置。
              </p>
              <Button
                size="sm"
        ...
        <StepCard
          ...
          doneContent={
            <>
              <p className="text-xs text-emerald-400/80 mb-1">智能体已注册</p>
              <button
        ...
        <StepCard
          ...
          doneContent={
            <>
              <p className="text-xs text-emerald-400/80 mb-1">任务已进入队列</p>
              <button
                className="text-2xs text-muted-foreground hover:text-foreground"
