...
export function AgentSquadPanelPhase3() {
  ...
  if (loading && agents.length === 0) {
    return <Loader variant="panel" label="正在加载智能体" />
  }
...
function AgentDetailModalPhase3({
  ...
  const tabs = [
    ...
    { id: 'files', label: '文件', icon: 'F' },
    { id: 'tools', label: '工具', icon: 'W' },
    { id: 'models', label: '模型', icon: 'P' },
    { id: 'channels', label: '频道', icon: 'H' },
    { id: 'cron', label: 'Cron', icon: 'R' },
    { id: 'soul', label: 'SOUL', icon: 'S' },
    { id: 'memory', label: '记忆', icon: 'M' },
    { id: 'tasks', label: '任务', icon: 'T' },
    { id: 'config', label: '配置', icon: 'C' },
    { id: 'activity', label: '活动', icon: 'A' }
  ]
...
function QuickSpawnModal({
  ...
  const models = [
    { id: 'haiku', name: '千问 Flash', cost: '本地', speed: '极速' },
    { id: 'sonnet', name: '千问 Plus', cost: '本地', speed: '快速' },
    { id: 'opus', name: '千问 Max', cost: '本地', speed: '深度' },
    { id: 'groq-fast', name: 'Llama 8B', cost: '网关', speed: '840 tok/s' },
    { id: 'groq', name: 'Llama 70B', cost: '网关', speed: '150 tok/s' },
    { id: 'deepseek', name: 'DeepSeek R1', cost: '本地', speed: '本地' },
  ]
