...
const actionColors: Record<string, string> = {
  ...
  role_denied: 'text-destructive',
  backup_create: 'text-primary',
  backup_delete: 'text-destructive',
  settings_update: 'text-primary',
  auto_backup: 'text-primary',
  heartbeat_check: 'text-muted-foreground',
  agent_config_sync: 'text-primary',
  local_agent_sync: 'text-primary',
  integration_test: 'text-primary',
  agent_register: 'text-primary',
  agent_update: 'text-primary',
  agent_create: 'text-primary',
  agent_delete: 'text-destructive',
  token_rotate: 'text-primary',
  gateway_config_update: 'text-primary',
  login_google: 'text-primary',
  google_disconnect: 'text-muted-foreground',
  workspace_create: 'text-primary',
  workspace_update: 'text-primary',
  workspace_delete: 'text-destructive',
  cleanup: 'text-muted-foreground',
  export: 'text-primary',
  access_request: 'text-primary',
  access_approve: 'text-primary',
  access_deny: 'text-destructive',
}
