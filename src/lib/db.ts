...
import { shouldStartBuiltinScheduler } from './scheduler-leader';
...
function initializeSchema() {
  ...
  try {
    ...
    if (!webhookListenerInitialized) {
      ...
      // Start only for a live runtime. Builds, isolated probes/tests and an
      // explicitly disabled drain slot must not touch scheduler state.
